...
namespace TugasKu_TUBES_KPL
{
    public class TaskForm : Form
    {
        ...
        private void InitUI()
        {
            ...
            cbPriority.Items.AddRange(new string[]
            {
                "🔴 High",
                "🟡 Medium",
                "🟢 Low"
        ...
        {
            string name = txtName.Text == txtName.Placeholder
                ? ""
                : txtName.Text.Trim();

            string course = txtCourse.Text == txtCourse.Placeholder
                ? ""
                : txtCourse.Text.Trim();
            ...
            {
                MessageBox.Show(
                    "Nama tugas dan mata kuliah wajib diisi.",
                    "Validasi",
            ...
            TaskStatus targetStatus =
                (TaskStatus)cbStatus.SelectedIndex;

            if (existingTask != null)
            {
                try
                {
                    AppStateValidator.ApplyTransition(
                        existingTask,
                        targetStatus);
                }
