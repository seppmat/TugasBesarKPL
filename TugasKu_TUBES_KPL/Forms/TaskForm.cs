    ...
    public class TaskForm : Form
    {
        ...
        private void InitUI()
        {
            ...
            void AddField(string label, Control ctrl, ref int yPos)
            {
                ...
                {
                    Text = label,
                    Location = new Point(marginX, yPos),
                    Font = UIScaler.ScaleFont(new Font("Segoe UI", 10, FontStyle.Bold)),
                    AutoSize = true
                });
                ...
                ctrl.Width = width;
                ctrl.Height = 40;
                ctrl.Font = UIScaler.ScaleFont(new Font("Segoe UI", 10));
            ...
            txtCourse = new PlaceholderTextBox
            {
            ...
            btnSave = new RoundedButton
            {
                ...
                Cursor = Cursors.Hand,
                Radius = 10,
                Location = new Point(marginX, y + 20),
                Width = width,
                Height = 45,
                Font = UIScaler.ScaleFont(new Font("Segoe UI", 11, FontStyle.Bold))
            };
            ...
            btnCancel = new Button
            {
                ...
                FlatStyle = FlatStyle.Flat,
                Cursor = Cursors.Hand,
                Location = new Point(marginX, y + 75),
                Width = width,
                Height = 40,
                Font = UIScaler.ScaleFont(new Font("Segoe UI", 10))
            };
        ...
        private void SaveTask(object sender, EventArgs e)
        {
            ...
            var tempTask = new TaskItem
            {
                ...
                Priority = (TaskPriority)cbPriority.SelectedIndex,
                Status = (TaskStatus)cbStatus.SelectedIndex
            };

            bool isValid = GenericValidator<TaskItem>.IsValid(tempTask, t => t.ValidateAll());

            if (!isValid)
            {
                MessageBox.Show(
                    "Data tidak valid: Nama/Kuliah kosong atau deadline terlewat.",
                    "Validasi Gagal",
